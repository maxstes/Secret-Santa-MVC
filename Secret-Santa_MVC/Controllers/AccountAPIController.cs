...
namespace Secret_Santa_MVC.Controllers
{
    public class AccountAPIController : Controller
    {
      ...
      //  private readonly IServiceProvider _serviceProvider;
        public AccountAPIController(IAppUserService appUserService,ITokenService tokenService, SantaContext context, UserManager<ApplicationUser> userManager, IConfiguration configuration)// IServiceProvider serviceProvider)
        {
